    ...
    return (
      <div>
        <div>
          ...
          <input type="radio" name="podcast" value="podcast" onChange={this.onPodcastChange} checked={true}/>Podcast
          <input type="radio" name="movie" value="movie" onChange={this.onPodcastChange}/>Movie
